...
const SocialProofModal = ({ isOpen, onClose }) => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/Adokiye",
      icon: FaGithub,
      label: "github.com/Adokiye",
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/mishael-williams/",
      icon: FaLinkedin,
      label: "linkedin.com/in/mishael-williams",
    },
    {
      name: "Email",
      url: "mailto:williamsmishaeldev@gmail.com",
      icon: MdEmail,
      label: "williamsmishaeldev@gmail.com",
    },
    {
      name: "Phone",
      url: "tel:+17208273199",
      icon: MdPhone,
      label: "+1-720-827-3199",
    },
    {
      name: "Location",
      url: "https://maps.google.com/?q=South+Harrison+Street,+Denver,+USA",
      icon: MdLocationOn,
      label: "South Harrison Street, Denver, USA",
    },
  ];
